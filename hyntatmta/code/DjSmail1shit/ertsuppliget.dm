...
/obj/item/device/ertsupplyget/attack_self(mob/living/user)
	...
	if(response)
		switch(response)
			...
			if("Brig") new/obj/structure/closet/crate/secure/weapon/ertammo(locate(139,179,1))
			if("Bridge") new/obj/structure/closet/crate/secure/weapon/ertammo(locate(113,134,1))
			if("R&D") new/obj/structure/closet/crate/secure/weapon/ertammo(locate(182,118,1))
		to_chat(user, "We send you supplies in [response].")
		qdel(src)



/obj/structure/closet/crate/secure/weapon/ertammo
...
/obj/structure/closet/crate/secure/weapon/ertammo/New()
	..()
