...
/mob/living/carbon/human/handle_disabilities()
		...
		if((prob(10) && paralysis <= 1))
			...
			switch(rand(1, 3))
				if(1)
					emote("twitch")
				if(2 to 3)
					var/tourettes = pick("ÃÎÂÍÎ", "ÌÎ×À", "ÅÁÀÒÜ", "ÃÎÍÄÎÍ", "ÕÓÅÑÎÑ", "ÏÈÄÀÐ", "ÕÓÉ")
	...
	if(getBrainLoss() >= 60 && stat != DEAD)
		speech_problem_flag = 1
		if(prob(3))
			var/list/s1 = list("âñåì ïðèâåò ñ âàìè èèâàíãàé è ýòî ìîé îáçîð íà ñïåññòåéøí ôåðòèí",
							   "áåç êåñëîðîäà áëîá íå ðàñòåò?",
							   "ÊÝÏ - ÃÎÍÄÎÍ",
							   "[pick("", "åòîò òðèòîð")] [pick("âèíñ", "âèíñîíò", "âèíñåíò", "âèíñóíò")] [pick("àíòäàð", "îäàð", "óäàð")] ãðåôîíèò ìèíÿ õàëï!!!",
							   "íå ìîãëè áû âû ìåíÿ òûêíóòü [pick("òåëèêåíåçîì","õóëêîì","åïåëåïñèåé")]?",
							   "Õî÷åøü ðóêè-áàçóêè?",
							   "ß ÐÎÑÑÈÉÑÊÈÉ ÍÎÂÛÉ ÏÈÐÀÒ",
							   "SONO CHI NO SADAME --- JOOOOOOOOOOOOOOJOOOOOOOOOOOOOOO",
							   "íå ãðèôîíü ïîäóìîé!!!!",
							   "ÀÑÒÀÍÀÂÈÒÅÑÜ#",
							   "åáàòü ïîâèäëèò",
							   "êîãäà ëàâàëåíä?",
							   "[pick("àé áëÿ","àààà","")] ýòîò òðàï [pick("Öèðè","Êèðè","Êèðèëë","Ñèðè","Êèðþõà")] [pick("Ïîêåò","Ïàêåò","Êàðìàí", "Êàðìàííûé")] ðàññêàçûâàåò ìíå ïðî [pick("òî êàê â ñá ñëóæàò","áóðãåðû âî ôðàíöèè","òî êàê íà íåãî áàòÿ îðàë", "îí ìåíÿ ùàñ òðàõíåò")] ïîìîãèòå!!!!!",
							   "ñóøèëêà íå ðàáîòàåò, ôèêñàíèòå",
							   "êåê",
							   "ýòî ôèàñêî áðàòàí")

			var/list/s2 = list("FUS RO DAH",
							   "åáó÷èå ôóðèåáû!",
							   "÷îìó åòîò òðåòîð òîêîè äîâîëüíûé",
							   ">ìîå ëèòñå",
							   "ñäåëàé áî÷êó",
							   "âàààààààààààààààãõ!!!",
							   "õåõ ñìîòðåëè ôèëòèôðåíêà? ìíå 15 êñòàòè",
							   "ÇÀ ÈÌÏÅÐÀÒÎÐÀ!",
							   "äåä, ñìîòðè, ñîáàêà ñèäèò. ËÎË.",
							   "èòñ ý õàé íóóóóóóóóóí",
							   "ÌÛ ÏÅÑ ÌÀÐÈÍÛÛÛÛÛÛÛÛÛÛÛ",
							   "÷àñ ïðîñòàòû",
							   "òåêñòóðêè-òî ïðîøëûé âåê!",
							   "ñíåê, òû âåðèøü ÷òî ëþáîâ ìîæåò ðàñöâåñòè íà ïîëå áîÿ?",
							   "ÌÎÉ ÏÈÍÃ!!!!!")
			switch(pick(1,2,3))
				if(1)
					say(pick(s1))
